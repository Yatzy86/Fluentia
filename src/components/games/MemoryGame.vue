        ...
        <div
            ...
            <div class="card-inner">
                ...
                <div class="card-front">
                    <img src="../../assets/img/MemoryCard.png" style="width:100px; height:100px;"/>
                </div>
                <!--flipped card trasnition-->
                <div class="card-back"> 
                    <span>{{ card.word }}</span>
...
const totalPairs = computed(() => new Set(cards.value.map(c => c.pairId)).size) 
const hasWon = computed (() => matchedPairs.value > 0 && matchedPairs.value === totalPairs.value )
const totalXP = ref(0)
